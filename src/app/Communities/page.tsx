    ...
    <div className='bg-[#f1fff6]'>
      ...
      <div className='flex justify-center '>
        ...
        <div className='w-[80%] flex gap-8'>
          <div className='basis-2/3 pr-5 flex flex-col gap-[66px]'>
            ...
            <div>
              ...
              <div className='flex flex-wrap mt-4 gap-[18px] '>
            ...
            <div className='w-[691px] h-[940px]  rounded-xl border relative overflow-hidden'>
              <img src='/images/knowledge/frame.png' className='absolute  h-full' alt='partner' />
              <div className='relative py-[74px] px-[44px] flex flex-col gap-[60px]'>
                <div>
                  <p className='font-bold text-[2.6rem] text-white leading-[50px] '>Benefits of joining the OLL community</p>
                </div>
          ...
          <div className='basis-1/3 min-w-[442px] max-h-[882px] rounded-xl flex flex-col gap-4 p-11 bg-white shadow-logobox'>
            <div>
            ...
            <div className='flex flex-col mt-6 gap-4 mx-4 '>
