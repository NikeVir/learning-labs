    ...
    return (
        <div className='bg-[#f1fff6]'>
            ...
            <div className='flex justify-center mb-20'>
                <div className='w-[80%] p-10 flex gap-16 flex-col bg-white shadow-featurebox'>
                            ...
                            <div className='grid grid-cols-3 gap-20'>
                                <div className='flex flex-col  gap-5'>
                                    <div className='flex gap-[74px]'>
                                        <div className='bg-[#F4F4F4] w-[60px] h-[60px] rounded-[100%] text-center flex justify-center items-center text-2xl font-semibold'>1</div>
                                    ...
                                    <div className='gap-5 flex flex-col'>
                                        ...
                                        <p className='w-[284px] text-sm font-medium text-[#161616]'>Identify the current practices, approaches & challenges in the industry via interview</p>

                                    </div>
                                </div>
                                <div className='flex flex-col  gap-5'>
                                    <div className='flex gap-[74px]'>
                                        <div className='bg-[#F4F4F4] w-[60px] h-[60px] rounded-[100%] text-center flex justify-center items-center text-2xl font-semibold'>2</div>
                                        <img src='/images/communities/line.svg' className='w-[158px]' alt='benefits' />
                                ...
                                <div className='flex flex-col  gap-5'>
                                    <div className='flex gap-[74px]'>
                                        <div className='bg-[#F4F4F4] w-[60px] h-[60px] rounded-[100%] text-center flex justify-center items-center text-2xl font-semibold'>3</div>
