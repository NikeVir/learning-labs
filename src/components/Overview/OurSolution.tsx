...
const data = [
    {
        ...
        img:'/images/scrollcontent/business.svg',
    ...
    },
    {
        ...
        img:'/images/scrollcontent/group2.svg',
    ...
    },
    {
        ...
        img:'/images/scrollcontent/group1.svg',
    ...
    },
    {
        ...
        img:'/images/scrollcontent/tool.svg',
...
export default function OurSolution() {
  return (
    <div>
        <div className='min-h-screen py-10 pb-20 w-full border flex flex-col gap-16 items-center border-black'>
            <div>
            ...
            <div className='w-[80%] grid grid-flow-col grid-cols-4 gap-8'>
                {
                    data.map((item, index) => (
                        <div key={index} style={{background:item.containerCol}} className={`max-[300px] flex flex-col   `}>
                            <div style={{border:`3px solid ${item.color}`}} className='flex  mb-2 items-center  min-h-[100px] bg-white justify-center '>
                            ...
                            <div className='px-4 py-2'>
                                <p className='text-sm text-[#004B96] font-medium'>
                                    {item.desc}
                                </p>
                            </div>
                        </div>
