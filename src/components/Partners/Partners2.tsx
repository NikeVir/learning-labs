    ...
    <div className='py-20 flex justify-center items-center'>
      <div className='w-[95%] xl:w-[80%]'>
        ...
        <div className='flex justify-center max-lg:flex-wrap mt-[50px] gap-16'>
          <div className='relative bg-[rgba(250,250,250,0.08)] rounded-[20px] w-[400px] h-[405px] border border-[#E6E6E6] flex justify-center items-center hover:border-[#FF3438] hover:border-[3px] hover:bg-[#040509] group transition-all duration-300'>
            ...
            <div className='absolute top-0 left-0 w-full h-full rounded-[20px] bg-black bg-opacity-80 text-white p-4 flex items-center justify-center text-center opacity-0 group-hover:opacity-100 group-hover:visible transition-opacity duration-300'>
