  ...
  return (
    <div className='flex justify-center min-h-[100vh] '>
        <div className='w-[95%] xl:w-[80%] my-16'>
                ...
                <div className='flex justify-center max-lg:flex-wrap w-full gap-6 mt-16 sm:min-h-[80vh] '>
                    {
                        data.map((item, index) => (
                            <div className='relative min-w-[350px] lg:min-w-[320px] xl:min-w-[368px] h-[501px]' key={index}>
                                <img src={item.image} className='absolute min-w-[3px] lg:min-w-[320px] xl:min-w-[368px] h-[501px]' alt="placeholder" />
